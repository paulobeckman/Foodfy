...
const { onlyUsers, isAdminUserRedirectToUsers, cannotDeleteYourProfile } = require('../../app/middlewares/session')
...
routes.delete('/users/:id', onlyUsers, cannotDeleteYourProfile, UserController.delete) // Deletar um usuário
